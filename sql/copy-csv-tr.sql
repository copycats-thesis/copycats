\copy tr.fund_characteristics FROM PROGRAM '7z x "D:/Cloud Storages/GitHub/copycats-analysis/data/clean/wrds-tr-s12-type1-197901-201509.csv.gz" -so' DELIMITER ','  CSV HEADER ;
